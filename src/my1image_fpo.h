...
float* frame_make(my1frame_t *image, int height, int width);
void frame_free(my1frame_t *image);
void frame_copy(my1frame_t *src, my1frame_t *dst);
float frame_get_pixel(my1frame_t *image, int row, int col);
void frame_set_pixel(my1frame_t *image, int row, int col,float pixel);
/* frame mask kernel */
...
void frame_convolute(my1frame_t *src, my1frame_t *dst,
	my1frame_kernel_t *kernel);
/*----------------------------------------------------------------------------*/
#endif
/*----------------------------------------------------------------------------*/
